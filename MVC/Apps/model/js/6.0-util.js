...
$("#utilbar4").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('测量', '#utilbar4', {
            tips: [4, '#78BA32']
        });
    }
});
...
$("#utilbar5").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('新任务', '#utilbar5', {
            tips: [4, '#78BA32']
        });
    }
});
...
$("#utilbar6").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('工具', '#utilbar6', {
            tips: [4, '#78BA32']
        });
    }
});
