...
$("#utilbar5").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('标注', '#utilbar5', {
            tips: [4, '#78BA32']
        });
    }
});
...
$("#utilbar6").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('待处理任务', '#utilbar6', {
            tips: [4, '#78BA32']
        });
    }
});
