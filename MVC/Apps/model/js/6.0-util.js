...
$("#utilbar3").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('测量', '#utilbar3', {
            tips: [4, '#78BA32']
        });
    }
});
...
$("#utilbar4").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('绘图', '#utilbar4', {
            tips: [4, '#78BA32']
        });
    }
});
