...
util.fixbar({
    ...
    , click: function (type) {
        if (type === 'bar1') {
            ...
            //无人几宏观地质巡视
            LoadwuRenJiXuShiLayer(currentprojectid);
        }
        else if (type === 'bar6') {
            //预警分析
...
$("#utilbar2").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('图层列表', '#utilbar2', {
            tips: [4, '#78BA32']
        });
    }
});
...
$("#utilbar3").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('设备管理', '#utilbar3', {
            tips: [4, '#78BA32']
        });
    }
});
...
$("#utilbar4").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('数据可视化', '#utilbar4', {
            tips: [4, '#78BA32']
        });
    }
});
...
$("#utilbar5").on("mouseenter", function () {
    //if (tipslayer == -1) {
    //    tipslayer = layer.tips('综合分析', '#utilbar5', {
    //        tips: [4, '#78BA32']
    //    });
    //}
    if (tipslayer == -1) {
        tipslayer = layer.tips('无人机巡视', '#utilbar5', {
            tips: [4, '#78BA32']
        });
    }
});
...
$("#utilbar6").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('预警分析', '#utilbar6', {
            tips: [4, '#78BA32']
        });
    }
});
...
$("#utilbar7").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('测量', '#utilbar7', {
            tips: [4, '#78BA32']
        });
    }
});
...
$("#utilbar9").on("mouseenter", function () {
    if (tipslayer == -1) {
        tipslayer = layer.tips('工具', '#utilbar9', {
            tips: [4, '#78BA32']
        });
    }
});
$("#utilbar9").on("mouseleave", function () {
    if (tipslayer != -1) {
        layer.close(tipslayer);
        tipslayer = -1;
    }
